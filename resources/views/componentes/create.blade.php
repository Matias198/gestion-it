...
@section('content')
    <div class="mx-auto max-w-2xl">
        <div class="text-white border-b border-gray-900/10">
            <p class="text-3xl mb-3 mt-3 text-gray-900 dark:text-white">Crear componente</p>
            <form action="{{ route('componentes.store') }}" method="POST">
                ...
                <button type="submit"
                    ...
                    componente</button>
                <input type="hidden" id="tipo_componenete" name="tipo_componenete" value="" style="color:black">
            </form>
        </div>
    </div> 
    <script>
