...
<head>
    ...
    <!-- Styles --> <link href="https://unpkg.com/tailwindcss@^1.0/dist/tailwind.min.css" rel="stylesheet">
...
<body class="antialiased bg-slate-800">
    <nav class="sticky top-0 z-50 w-full border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700" style="box-shadow: 0 0 15px 5px rgba(0,0,0, 0.5);">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="#"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Registrar Usuario</span>
                    </a>
                </li>
                <li>
                    <a href="#"
