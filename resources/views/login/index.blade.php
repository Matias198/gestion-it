...
<body class="antialiased bg-slate-900">
    <h1 class="text-center mt-16 text-white text-2xl">GestionIT <br> • Iniciar Sesion •</h1>
    <div style="display: flex; height: 70vh; align-items: center">
        <div class="text-center bg-slate-800 p-16 rounded shadow-black shadow-md"
            style="margin: 0 auto; vertical-align: middle;">
            <form action="{{ route('auth.login.submit') }}" method="POST" style="">
                @csrf
                ...
                <div class="flex items-start mb-6">
                    ...
                    <label for="remember"
                        class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Recordarme</label>
                </div>
                <button type="submit"
            ...
            <br>
            <label for="btn-registro" class="text-white">No tenés una cuenta?</label>
            <a id="btn-registro" class="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                href="{{ route('auth.register') }}">Registrate ahora</a>
