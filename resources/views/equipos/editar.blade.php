            ...
            <form action="{{ route('equipos.update', $equipo->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <select id="estado" name="estado" required
                        ...
                        <option @if ($equipo->estado == 'Disponible') selected @endif value="Disponible">Disponible</option>
                        <option @if ($equipo->estado == 'No disponible') selected @endif value="No disponible">No disponible</option> 
                    </select> 
                </div>
                <label for="categoria"
                ...
                <select id="categoria" name="categoria"
                    ...
                    @foreach ($categorias as $categoria)
                        ...
                        <option @if ($categoria->id == $equipo->categoria_id) selected @endif value="{{ $categoria->id }}">
                    ...
                    <div id="componentes" class="flex items-center mb-4">
                        ...
                        <input id="default-checkbox" type="checkbox" value="{{ $componente->id }}"
                            ...
                            @foreach ($equipo->componentes as $comp)
                                @if ($comp->id == $componente->id) checked @endif @endforeach>
