...
@section('content')
    <div class="mx-auto max-w-2xl">
        <div class="text-white border-b border-gray-900/10">
            <p class="text-3xl mb-3 mt-3 text-gray-900 dark:text-white">Editar Usuario</p>
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="email" id="email" name="email"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="name@mail.com" value="{{ $user->email }}" required>
                </div>
                <div class="mb-6">
                    <label for="password"
                ...
                <input type="hidden" id="role_id" name="role_id" value="{{ $user->role_id }}" style="color:black">
